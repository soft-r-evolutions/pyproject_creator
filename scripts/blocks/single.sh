...
function process_single {
    ...
    run "sed -i 's/project_name/${project_name}/g' ${project_path}/${project_name}/__init__.py"
    ...
    run "sed -i 's/ProjectName/${project_pascal_case}/g' ${project_path}/${project_name}/__init__.py"
    ...
    run "sed -i 's/projectName/${project_camel_case}/g' ${project_path}/${project_name}/__init__.py"
...
function test_single {
    ...
    run "[ -e ${project_path}/${project_name}/__init__.py ]"
