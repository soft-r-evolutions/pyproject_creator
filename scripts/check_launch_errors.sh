function usage {
    ...
    echo "- [simple|single|complex]: Python project layout."
    echo "-   simple: Simple application project layout."
    echo "-   single: Single package project layout."
    echo "-   complex: Application with internal lib project layout."
